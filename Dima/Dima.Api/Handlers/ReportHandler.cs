...
public class ReportHandler(AppDbContext context) : IReportHandler
{
    ...
    public async Task<Response<List<ExpensesByCategory>?>> GetExpensesByCategoryReportAsync(GetExpensesByCategoryRequest request)
    {
        ...
        {
            return new Response<List<ExpensesByCategory>?>(null, 500, "Não foi possivel obter as entradas por categoria");
        }
    }
    ...
    public async Task<Response<FinancialSummary?>> GetFinancialSummaryReportAsync(GetFinancialSummaryRequest request)
    {
        ...
        {
            return new Response<FinancialSummary?>(null, 500, "Não foi possivel obter o resultado financeiro");
        }
    }
}